...
extension MultiArray {
    ...
    ///
    /// The `pointer` methods provides views to the underlying raw address at a given location.
    ///
    /// For example, for a 2D array, you can use `matrix.pointer(i).pointee` to get `matrix[i, 0]`, or `Buffer(baseAddress: matrix.pointer(i), count: width)` to get the `i`th row.
    ///
    /// Furthermore, because the underlying buffer is raw-major contiguous, you can use `Buffer(start: matrix.pointer(i), count: width * 2)` to get the `matrix[i:i+1, :]` slice.
    ///
    /// - Precondition: dimension count must be at least `1`.
    ///
    /// - Complexity: Integer arithmetic (multiplication).
    @inlinable
    public nonisolated func pointer(_ dim0: Int) -> UnsafeMutablePointer<Element> {
    ...
    /// - Complexity: Integer arithmetic (multiplication).
    @inlinable
    public nonisolated func pointer(_ dim0: Int, _ dim1: Int) -> UnsafeMutablePointer<Element> {
    ...
    /// - Complexity: Integer arithmetic (multiplication).
    @inlinable
    public nonisolated func pointer(_ dim0: Int, _ dim1: Int, _ dim2: Int) -> UnsafeMutablePointer<Element> {
    ...
    /// - Complexity: Integer arithmetic (multiplication).
    @inlinable
    public nonisolated func pointer(_ dim0: Int, _ dim1: Int, _ dim2: Int, _ dim3: Int) -> UnsafeMutablePointer<Element> {
    ...
    /// - Complexity: Integer arithmetic (multiplication).
    @inlinable
    public nonisolated func pointer(_ dim0: Int, _ dim1: Int, _ dim2: Int, _ dim3: Int, _ dim4: Int) -> UnsafeMutablePointer<Element> {
    ...
    /// - Complexity: Integer arithmetic (multiplication).
    @inlinable
    public nonisolated func pointer(_ dim0: Int, _ dim1: Int, _ dim2: Int, _ dim3: Int, _ dim4: Int, _ dim5: Int) -> UnsafeMutablePointer<Element> {
